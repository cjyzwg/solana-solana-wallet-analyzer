...
# Fork From [analyze](https://github.com/Lucifer1590/solana-transaction-analyzer) 

The author use python script,I change it to golang

Just use manual install part,account put in .env file
